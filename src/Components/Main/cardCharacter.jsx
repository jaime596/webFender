        ...
        try {
            return <>
                <Row justify='center' align='middle'>
                    <Col span={24}>
                        <Row justify='center' align='middle'>
                            <Avatar size={128} src={this.state.detail.image} shape='circle'></Avatar>
                        </Row>
                        <Row justify='center' align='middle'>
                            <Badge
                                color={this.status(this.state.detail.status)}
                                text={this.state.detail.status + " - " + this.state.detail.species} />
                        </Row>
                    </Col>
                </Row>
                <Row justify='start' align='middle' gutter={8} >
                    <Col span={12}>
                        <Row justify='center' align='middle' gutter={8} >
                            <Col>
                                <Statistic title="Create:" value={moment(this.state.detail.created).utc().format("DD/MM/YYYY, h:mm a")} />
                                <Statistic title="Gender:" value={this.state.detail.gender} />
                                <Statistic title="Location:" value={this.state.detail.location.name} />
                            </Col>
                        </Row>
                    </Col>
                    <Col span={12}>
                        <Row justify='center' align='middle' gutter={8} >
                            <Col>
                                <Statistic title="Origin:" value={this.state.detail.origin.name} />
                                <Statistic title="Type:" value={this.state.detail.type === "" ? "Humman" : this.state.detail.type} />
