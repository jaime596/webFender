        ...
        try {
            return <>
                <Row justify='center' align='middle'>
                    <Col span={24}>
                        <Row justify='center' align='middle'>
                            <Avatar size={128} src={this.state.character.image} shape='circle'></Avatar>
                        </Row>
                        <Row justify='center' align='middle'>
                            <Badge
                ...
                <Row justify='start' align='middle' gutter={8} >
                    <Col span={12}>
                        <Row justify='center' align='middle' gutter={8} >
                            <Col>
                                <Statistic title="Create:" value={moment(this.state.character.created).utc().format("DD/MM/YYYY, h:mm a")} />
                                <Statistic title="Gender:" value={this.state.character.gender} />
                                <Statistic title="Location:" value={this.state.character.location.name} />
                            </Col>
                        </Row>
                    </Col>
                    <Col span={12}>
                        <Row justify='center' align='middle' gutter={8} >
                            <Col>
                                <Statistic title="Origin:" value={this.state.character.origin.name} />
                                <Statistic title="Type:" value={this.state.character.type === "" ? "Humman" : this.state.character.type} />
                    ...
                    <Col span={12}>
                        <Input.Group size="default">
                            <Row gutter={8} justify="start">
                                <Col >
                                    <Statistic title="Last known location:" value={this.state.character.location.name} />
                                </Col>
                            </Row>
                            <Row gutter={8} justify="start">
                                <Col >
