...
export const getCharactersGET = (page) => {
  return WS + `/character/all?page=${page}`;
};
export const getinfoCharacterGET = () => {
  return WS + `/character/infoCharacter`;
};
export const getinfoPokemonGET = () => {
  return WS + `/pokemon/detail`;
};
